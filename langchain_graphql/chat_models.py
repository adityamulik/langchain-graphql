...
class ChatGraphQL(BaseChatModel):
    ...
    """GraphQL chat model integration.

    The default implementation echoes the first `parrot_buffer_length` characters of the input.

    # TODO: Replace with relevant packages, env vars.
    Setup:
        Install ``langchain-graphql`` and set environment variable ``GRAPHQL_API_KEY``.
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            GraphQL API key. If not passed in will be read from env var GRAPHQL_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatGraphQL.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatGraphQL.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatGraphQL supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatGraphQL supports async generation. Otherwise delete.
